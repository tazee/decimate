...
#
get_filename_component(filename "/Users/taz/Desktop/dev/decimate/build/_deps/lxsdk-subbuild/lxsdk-populate-prefix/src/lxsdk16.1v5_692025.zip" ABSOLUTE)
get_filename_component(directory "/Users/taz/Desktop/dev/decimate/build/_deps/lxsdk-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-lxsdk-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-lxsdk-populate${i}")
