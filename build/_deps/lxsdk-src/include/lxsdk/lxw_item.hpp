...
public:
  ...
  Delete (void)
  {
    ...
    LxResult
  UserChannelCount (unsigned int *count) const
  {
  ...
  BaseName (const char **name)
  {
    ...
    LxResult
  DuplicateChannel (ILxUnknownID from, unsigned int channelIndex, int channelVectorMode, const char **newChannelName)
  {
