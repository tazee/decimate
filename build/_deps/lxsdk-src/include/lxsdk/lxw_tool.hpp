...
namespace lx {
    ...
    static const LXtGUID guid_PathGeneratorPacket = {0x284B625A,0xC82E,0x4103,0xA8,0xE0,0xF7,0x84,0x86,0x87,0xBD,0x4B};
    ...
    static const LXtGUID guid_ParticleGeneratorPacket2 = {0x36001340,0xF153,0x4B32,0x82,0xA4,0x7D,0xA4,0x38,0x96,0x93,0x71};
    ...
    static const LXtGUID guid_PathGeneratorPacket1 = {0xAE70D946,0x8A9A,0x4A72,0x95,0xEC,0xBF,0xF8,0x56,0x39,0x1D,0x22};
    static const LXtGUID guid_ParticleGeneratorPacket = {0xEF9E8BC9,0xB875,0x40FC,0x8A,0x30,0xD3,0xB2,0x88,0xCB,0xC2,0x4C};
};
  ...
  public:
    ...
    virtual double
      pathgen_Bank (ILxUnknownID vts, double t)
        { return 0; }
    virtual int
      pathgen_CurveCount (void)
        { return 1; }
    virtual LxResult
      pathgen_SetCurveIndex (int idx)
        { return LXe_NOTIMPL; }
    virtual int
      pathgen_CurrentCurveIndex (void)
        { return 0; }
};
...
#define LXxD_PathGeneratorPacket_CurveCount int pathgen_CurveCount (void)
#define LXxO_PathGeneratorPacket_CurveCount LXxD_PathGeneratorPacket_CurveCount LXx_OVERRIDE
#define LXxC_PathGeneratorPacket_CurveCount(c) int c::pathgen_CurveCount (void)
#define LXxD_PathGeneratorPacket_SetCurveIndex LxResult pathgen_SetCurveIndex (int idx)
#define LXxO_PathGeneratorPacket_SetCurveIndex LXxD_PathGeneratorPacket_SetCurveIndex LXx_OVERRIDE
#define LXxC_PathGeneratorPacket_SetCurveIndex(c) LxResult c::pathgen_SetCurveIndex (int idx)
#define LXxD_PathGeneratorPacket_CurrentCurveIndex int pathgen_CurrentCurveIndex (void)
#define LXxO_PathGeneratorPacket_CurrentCurveIndex LXxD_PathGeneratorPacket_CurrentCurveIndex LXx_OVERRIDE
#define LXxC_PathGeneratorPacket_CurrentCurveIndex(c) int c::pathgen_CurrentCurveIndex (void)
template <class T>
class CLxIfc_PathGeneratorPacket : public CLxInterface
{
  ...
  Bank (LXtObjectID wcom, LXtObjectID vts, double t)
  {
    ...
    static int
  CurveCount (LXtObjectID wcom)
  {
    LXCWxINST (CLxImpl_PathGeneratorPacket, loc);
    return loc->pathgen_CurveCount ();
  }
    static LxResult
  SetCurveIndex (LXtObjectID wcom, int idx)
  {
    LXCWxINST (CLxImpl_PathGeneratorPacket, loc);
    try {
    ...
    static int
  CurrentCurveIndex (LXtObjectID wcom)
  {
    LXCWxINST (CLxImpl_PathGeneratorPacket, loc);
...
public:
  ...
  CurveCount (void)
  {
    ...
    LxResult
  SetCurveIndex (int idx)
  {
    return m_loc[0]->SetCurveIndex (m_loc,idx);
  }
    int
  CurrentCurveIndex (void)
  {
  ...
  public:
    ...
    virtual LxResult
      partgen_HintBoxSet (const LXtBBox *box, const LXtVector orient, const LXtPGenParticle *part)
        { return LXe_NOTIMPL; }
    virtual int
      partgen_SourceCount (void)
        { return 1; }
    virtual LxResult
      partgen_SetSourceIndex (int idx)
        { return LXe_NOTIMPL; }
    virtual int
      partgen_CurrentSourceIndex (void)
        { return 0; }
};
...
#define LXxD_ParticleGeneratorPacket_SourceCount int partgen_SourceCount (void)
#define LXxO_ParticleGeneratorPacket_SourceCount LXxD_ParticleGeneratorPacket_SourceCount LXx_OVERRIDE
#define LXxC_ParticleGeneratorPacket_SourceCount(c) int c::partgen_SourceCount (void)
#define LXxD_ParticleGeneratorPacket_SetSourceIndex LxResult partgen_SetSourceIndex (int idx)
#define LXxO_ParticleGeneratorPacket_SetSourceIndex LXxD_ParticleGeneratorPacket_SetSourceIndex LXx_OVERRIDE
#define LXxC_ParticleGeneratorPacket_SetSourceIndex(c) LxResult c::partgen_SetSourceIndex (int idx)
#define LXxD_ParticleGeneratorPacket_CurrentSourceIndex int partgen_CurrentSourceIndex (void)
#define LXxO_ParticleGeneratorPacket_CurrentSourceIndex LXxD_ParticleGeneratorPacket_CurrentSourceIndex LXx_OVERRIDE
#define LXxC_ParticleGeneratorPacket_CurrentSourceIndex(c) int c::partgen_CurrentSourceIndex (void)
template <class T>
class CLxIfc_ParticleGeneratorPacket : public CLxInterface
{
  ...
  HintBoxSet (LXtObjectID wcom, const LXtBBox *box, const LXtVector orient, const LXtPGenParticle *part)
  {
    ...
    static int
  SourceCount (LXtObjectID wcom)
  {
    LXCWxINST (CLxImpl_ParticleGeneratorPacket, loc);
    return loc->partgen_SourceCount ();
  }
    static LxResult
  SetSourceIndex (LXtObjectID wcom, int idx)
  {
    LXCWxINST (CLxImpl_ParticleGeneratorPacket, loc);
    try {
    ...
    static int
  CurrentSourceIndex (LXtObjectID wcom)
  {
    LXCWxINST (CLxImpl_ParticleGeneratorPacket, loc);
...
public:
  ...
  SourceCount (void)
  {
    ...
    LxResult
  SetSourceIndex (int idx)
  {
    return m_loc[0]->SetSourceIndex (m_loc,idx);
  }
    int
  CurrentSourceIndex (void)
  {
