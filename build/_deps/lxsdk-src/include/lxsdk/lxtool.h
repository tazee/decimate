...
// Tool flags can inform systems if the current operation is a direct modeling tool
// or if it is a procedural tool operation.  Tools may also flag that their current
// evaluation is only one in a series, in which case the multisource flag will be
// set.
